...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EpWhlumZK46bRyu71l58.6S7B6iV24SxpyyIZPkjUga.S6TstSNeC0w0GxGFge6vC4RnZP/5VihzYkjd0ihCFSw=')
nadya.loginResult()
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like By : THIRD\nContact Me : 👉 line.me/ti/p/4bvwOIMft8.",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add Me (^_^)\nยินดีที่ได้รู้จักนะ ヘ(^_^)ヘ",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":False,
    ...
    try:
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            nadya.sendText(op.param1,"บ๊ายบายยยยย..... " + nadya.getContact(op.param2).displayName +  "\nแร้วเจอกัลใหม่นะ . . . (p′︵‵。) 🤗")
		...
		nadya.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                nadya.sendMessage(msg)                
		nadya.sendText(msg.to,"นี่แหละแอดมิน (^_^)")	
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                ...
                nadya.sendAudio(msg.to,"hasil.mp3")
                    ...
                    beb = "สวัสดีครับ 😘 " +nadya.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"

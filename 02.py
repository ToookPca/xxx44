...
cl = LINETCR.LINE()
cl.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="EprnfgBcIglna9Jux3x1.Vm537HvN52AR3XEMBzrY8q.Wv9f8wBNZ1ODwEiYxBy1ptMtd+K5SR1tueffAgpjNY8=")
ki8.loginResult()
...
╠══════════════════════
║✰ ต้อนรับเปิด ➠เปิดข้อความต้อนรับ
║✰ ต้อนรับปิด ➠ปิดข้อความต้อนรับ
║✰ ข้อความออกเปิด ➠เปิดข้อความออกกลุ่ม
║✰ ข้อความออกปิด ➠เปิดข้อความออกกลุ่ม
║✰ ข้อความลบเปิด ➠เปิดข้อความคนลบ
║✰ ข้อความลบปิด ➠เปิดข้อความคนลบ
║✰ Mbot on ➠เปิดเเจ้งเตือนบอท
║✰ Mbot off ➠ปิดเเจ้งเตือนบอท
║✰ M on ➠เปิดเเจ้งเตือนตนเอง
║✰ M off ➠ปิดเเจ้งเตือนตนเอง
║✰ เปิดแท้ค ➠เปิดกล่าวถึงเเท็ค
║✰ ปิดแท้ค ➠ปิดกล่าวถึงเเท็ค
...
#========================================
                ...
                md = "─┅══Fc-PEA══┅─\n\n"
                if wait["likeOn"] == True: md+="􀬁􀆐􏿿 Auto like : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Auto like : ปิด 􀜁􀄰􏿿\n"
                if wait["alwayRead"] == True: md+="􀬁􀆐􏿿 Read : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Read : ปิด 􀜁􀄰􏿿\n"
                if wait["detectMention"] == True: md+="􀬁􀆐􏿿 Autorespon : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Autorespon : ปิด 􀜁􀄰􏿿\n"
                if wait["kickMention"] == True: md+="􀬁􀆐􏿿 Autokick: เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Autokick : ปิด 􀜁􀄰􏿿\n"
                if wait["Notifed"] == True: md+="􀬁􀆐􏿿 Notifed : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Notifed : ปิด 􀜁􀄰􏿿\n"
                if wait["Notifedbot"] == True: md+="􀬁􀆐􏿿 Notifedbot : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Notifedbot : ปิด 􀜁􀄰􏿿\n"
                if wait["acommentOn"] == True: md+="􀬁􀆐􏿿 Pea1 : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Pea1 : ปิด 􀜁\n"
                if wait["bcommentOn"] == True: md+="􀬁􀆐􏿿 Pea2 : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Pea2 : ปิด 􀜁􀄰􏿿\n"
                if wait["ccommentOn"] == True: md+="􀬁􀆐􏿿 Pea3 : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Pea3 : ปิด 􀜁􀄰􏿿\n"
                if wait["Protectcancl"] == True: md+="􀬁􀆐􏿿 Cancel : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Cancel : ปิด 􀜁􀄰􏿿\n"
                if wait["winvite"] == True: md+="􀬁􀆐􏿿 Invite : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Invite : ปิด 􀜁􀄰􏿿\n"
                if wait["pname"] == True: md+="􀬁􀆐􏿿 Namelock : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Namelock : ปิด 􀜁􀄰􏿿\n"
                if wait["contact"] == True: md+="􀬁􀆐􏿿 Contact : ปิด 􀜁􀄯􏿿\n"
                else: md+="􀬁􀆐􏿿 Contact : ปิด 􀜁􀄰􏿿\n"
                if wait["autoJoin"] == True: md+="􀬁􀆐􏿿 Auto join : เปิด 􀜁􀄯􏿿\n"
                else: md +="􀬁􀆐􏿿 Auto join : ปิด 􀜁􀄰􏿿\n"
                if wait["autoCancel"]["เปิด"] == True:md+="􀬁􀆐􏿿 Group cancel :" + str(wait["autoCancel"]["members"]) + " 􀜁􀄯􏿿\n"
                else: md+= "􀬁􀆐􏿿 Group cancel : ปิด 􀜁􀄰􏿿\n"
                if wait["leaveRoom"] == True: md+="􀬁􀆐􏿿 Auto leave : เปิด 􀜁􀄯􏿿\n"
                else: md+="􀬁􀆐􏿿 Auto leave : ปิด 􀜁􀄰􏿿\n"
                if wait["timeline"] == True: md+="􀬁􀆐􏿿 Share : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Share : ปิด 􀜁􀄰􏿿\n"
                if wait["clock"] == True: md+="􀬁􀆐􏿿 Clock Name : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Clock Name : ปิด 􀜁􀄰􏿿\n"
                if wait["autoAdd"] == True: md+="􀬁􀆐􏿿 Auto add : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Auto add : ปิด 􀜁􀄰􏿿\n"
                if wait["commentOn"] == True: md+="􀬁􀆐􏿿 Comment : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Comment : ปิด 􀜁􀄰􏿿\n"
                if wait["Backup"] == True: md+="􀬁􀆐􏿿 Backup : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Backup : ปิด 􀜁􀄰􏿿\n"
                if wait["qr"] == True: md+="􀬁􀆐􏿿 Protect QR : เปิด 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 Protect QR : ปิด 􀜁􀄰􏿿\n"
...
#========================================
                ...
                if wait["acommentOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["ข้อความออกเปิด"]:
                if wait["bcommentOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["ข้อความลบเปิด"]:
                ...
                if wait["acommentOn"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off")
            elif msg.text in ["ข้อความออกปิด"]:
...
#=============================================
            ...
            elif msg.text in ["เปิดแท้ค"]:
                wait["detectMention"] = True
                cl.sendText(msg.to,"Auto Respon ON")
                
            elif msg.text in ["ปิดแท้ค"]:
                wait["detectMention"] = False
                cl.sendText(msg.to,"ปิดแท้คแล้ว")
...
#==============================================================================#
            ...
            elif msg.text in ["Friendlist","เช็คเพื่อนทั้งหมด","เพื่อนทั้งหมด","เชคเพื่อน"]:    
            ...
            elif msg.text in ["Blocklist","บร๊อก","บล็อค"]: 
                blockedlist = cl.getBlockedContactIds()
                kontak = cl.getContacts(blockedlist)
                num=1
                msgs="═════════List Blocked═════════"
